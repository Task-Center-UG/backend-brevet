...
// UpcomingScheduleItem represents the next teaching schedule for a teacher
...
// TeacherDashboardResponse represents dashboard data for teachers
type TeacherDashboardResponse struct {
	...
	UpcomingSchedules []UpcomingScheduleItem `json:"upcoming_schedules"`
}

// StudentMeetingScoreItem represents score progress for a meeting
type StudentMeetingScoreItem struct {
	MeetingID     string    `json:"meeting_id"`
	MeetingTitle  string    `json:"meeting_title"`
...
// StudentScoreProgressResponse represents score progress per meeting for a student
type StudentScoreProgressResponse struct {
	BatchSlug  string                    `json:"batch_slug"`
	BatchTitle string                    `json:"batch_title"`
	Data       []StudentMeetingScoreItem `json:"data"`
}

// StudentDashboardResponse represents dashboard metrics for a student
